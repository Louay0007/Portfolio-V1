const mySelf = {
    ...
    paragraphs: [
        `
        Hello! My name is Louay Rjili , A 19-Years old student at IssatM , I like creating new things for internet. From a younger age, I have been interested in programming, as a kid most of my time I've spent in inspect element playing with colors and codes generating loops for sending infinite messages, cracking locked screen overflows and many more. so finally at the age of 16 I decided to convert this passion into career.`,
        `
        It is a way to become more crafty with my ideas and explore the endless possibilities in the world of programming.`,
        `
        Besides, Programming I'm a passionate Soccer Player and a Gamer .
        A First Tunisian who actually covered most of the Generative AI of city Tunis with moderative GAN's technology in all over Tunisia it helped more than 4 Millions people till now.`,
        `
        ...
        From local software house to Fiverr, Fiverr to Upwork and gradually towards national companies.`,
        `
